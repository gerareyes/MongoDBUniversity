...
of the tweet and the user's followers_count at the time they issued the tweet. 
...
O The query returns 251120 documents.
O The query is a covered query.
O The query uses an index to determine which documents match.
